...
@section('subhead')
    <title>Slider - DevSys - IMC System</title>
@endsection
                    ...
                    <div class="preview">
                        <div class="mx-6 pb-8">
                            <div class="fade-mode">
                                ...
                                <div class="h-64 px-2">
                                    <div class="h-full image-fit rounded-md overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" src="{{ asset('build/assets/images/' . $fakers[1]['images'][1]) }}" />
                                    </div>
                                </div>
                                <div class="h-64 px-2">
                                    <div class="h-full image-fit rounded-md overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" src="{{ asset('build/assets/images/' . $fakers[2]['images'][2]) }}" />
                                    </div>
                                </div>
                            </div>
                        </div>
