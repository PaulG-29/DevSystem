...
@section('subhead')
    <title>Image Zoom - DevSys - IMC System</title>
@endsection
                    ...
                    <div class="preview">
                        <div class="leading-relaxed">
                            ...
                            <div class="w-full h-64 my-5 image-fit">
                                <img alt="Midone - HTML Admin Template" src="{{ asset('build/assets/images/' . $fakers[0]['images'][0]) }}" data-action="zoom" class="w-full rounded-md">
                            </div>
                            <p class="mb-5">
                            ...
                            <div class="w-3/5 h-64 mr-6 float-left image-fit">
                                <img alt="Midone - HTML Admin Template" src="{{ asset('build/assets/images/' . $fakers[0]['images'][1]) }}" data-action="zoom" class="w-full rounded-md">
                            </div>
                            <p class="mb-5">
