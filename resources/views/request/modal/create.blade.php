...
<div id="create1" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
    ...
    <form action="{{ route('borrow.create')}}" method="POST">
        ...
        <div class="modal-content">
            ...
            <div class="py-6 px-6 lg:px-8">
               <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Add Borrower</h3>
                   <div>
                        
                       <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Borrower Name</label>
                       <input id="crud-form-1" name="borrower_name" type="text" class="form-control w-full" placeholder="Name" required>
                       ...
                       <select id="item" name="item_id" class="block appearance-none w-full bg-white border border-gray-200 px-4 py-2 pr-8 rounded-lg shadow leading-tight focus:outline-none focus:shadow-outline">
                        ...
                        <option value="{{ $borrow->id }}">{{ $borrow->item->item_name }}</option>
                        @endforeach --}}
                       ...
                       <input id="crud-form-3" name="date_borrow" type="date" class="form-control" placeholder="Borrow Date" aria-describedby="input-group-1" required>
                       <label for="date" class="block text-sm font-medium text-gray-900 dark:text-gray-300 m">Expect. Returned</label>
                       <input id="crud-form-3" name="date_returned" type="date" class="form-control" placeholder="Expected Returned" aria-describedby="input-group-1" required>
                   </div>
